...
function InterviewFollowUp1Filter({ onclose }) {
  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.interviewFollowUp1Filter
  );
  ...
  useEffect(() => {
    Dispatch(CandidatePipelineActions.setInterviewFollowUp1Filter(filterData));
  }, [filterData]);

  function handleSubmit() {
    Dispatch(CandidatePipelineActions.setInterviewFollowUp1Filter(filterData));
    onclose();
    // console.log(CandidatePipelineActions.setInterviewFollowUp1Filter(filterData));
  }
...
export default InterviewFollowUp1Filter;
