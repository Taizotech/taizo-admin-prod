...
function ConnectingQualifyingPipeline() {
  ...
  let filterDetails = useSelector(
    (state) =>
      state.CandidatePipelineDetails.interviewStatusConnectingQualifying
  );
  ...
  function paginationChange(event, page) {
    Dispatch(
      CandidatePipelineActions.setPageChange({
        type: "interviewStatusConnectingQualifying",
        value: page - 1,
      })
    );
  }
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  >
                    {el.interviewStatusCallReminderOn
                      ? (() => {
      ...
      {showFilter && (
        <MyModal>
          <ModalContainer
            ...
            childComponent={
              <>
                <AttendingConnectingQualifyingFilter
                  onclose={() => {
                    setShowFilter(false);
                  }}
                />
                ...
                <>
                  <div style={{ width: "380px" }}>
                    ...
                    <form onSubmit={(e) => submitOfferrejected(e)}>
                      <div className="mt-2">
                        <span>
                          Are you sure that you want to offer reject{" "}
                          <b>
                            {leadDetails.firstName} {leadDetails.lastName}
                          </b>{" "}
                          ?
