...
import JoinningFollowUp1LeadFilter from "./joinningFollowUp1Filter";

function JoinningFollowUp1LeadPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joinningFollowUp1Lead
  );
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                <div className="d-flex justify-content-between">
                  ...
                  {/* <div>
                    {dateFormate(el.joiningFollowUpDate1) ===
...
export default JoinningFollowUp1LeadPipeline;
