...
import Joining1ConnectingFilter from "./joining1ConnectingFilter";

function Joinning1ConnectingPipeline() {
  ...
  let filterDetails = useSelector(
    (state) =>
      state.CandidatePipelineDetails.joinningFollowUp1ConnectingQualifying
  );
  ...
  function paginationChange(event, page) {
    Dispatch(
      CandidatePipelineActions.setPageChange({
        type: "joinningFollowUp1ConnectingQualifying",
        value: page - 1,
      })
    );
  }
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  >
                    {el.joiningFollowup1CallReminderOn
                      ? (() => {
...
export default Joinning1ConnectingPipeline;
