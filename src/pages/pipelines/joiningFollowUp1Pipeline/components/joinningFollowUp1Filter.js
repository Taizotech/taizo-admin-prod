...
import { MyModal, addDaysToDate, dateFormate, modifyDate } from "../../../../utility";
...
function JoinningFollowUp1LeadFilter({ onclose }) {
  ...
  const [filterData, setFilterData] = useState({
    ...
    // joiningStatus: filterDetails.joiningStatus,
    page: 0,
  ...
  useEffect(() => {
    Dispatch(
      CandidatePipelineActions.setCommonPipelineFilter({
  ...
  function handleSubmit() {
    ...
    onclose();
    // console.log(CandidatePipelineActions.setCommonPipelineFilter(filterData));
  }
...
export default JoinningFollowUp1LeadFilter;
