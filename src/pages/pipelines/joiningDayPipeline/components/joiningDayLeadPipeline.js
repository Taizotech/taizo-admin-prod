...
import JoiningDayLeadFilter from "./joiningDayLeadFilter";

function JoiningDayLeadPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joiningDayLead
  );
  ...
  return (
    <div className={`${style.pipelineContainer} mx-2`}>
      <div className={`${style.headerCard} p-2 d-flex justify-content-between`}>
        <b> Joining Day Lead ({totalCount})</b>{" "}
        <div className="mt-1">
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                <div className="d-flex justify-content-between">
                  ...
                  {/* <div>
                    {dateFormate(el.joiningDateSetOn) ===
...
export default JoiningDayLeadPipeline;
