...
function InterviewAttendingFilter({ onclose }) {
  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.attendingLead
  );
  ...
  useEffect(() => {
    console.log(filterDetails, "filterDetails filterDetails");
  }, [filterDetails]);
...
export default InterviewAttendingFilter;
