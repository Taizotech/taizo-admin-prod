...
function InterviewAttendedPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.interviewAttended
  );
  ...
  return (
    <div className={`${style.pipelineContainer} mx-2`}>
      <div className={`${style.headerCard} p-2 d-flex justify-content-between`}>
        <b> Interview Attended ({totalCount})</b>{" "}
        <div className="mt-1">
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                <div className="d-flex justify-content-between">
                  ...
                  {/* <div>{el.interviewScheduledOn===dateFormate(new Date())?<div className="d-flex aligin-items-center justify-content-center" ><img src={greengif} alt="" className="" width={"40px"} height={"25px"}  style={{marginTop:"2.3px"}}/></div>:""}</div> */}
                </div>
                {/* <br /> */}
                    ...
                    <form onSubmit={(e) => submitCallRemainder(e)}>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          const formattedDateTime = inputDateTime + ":05";
...
export default InterviewAttendedPipeline;
