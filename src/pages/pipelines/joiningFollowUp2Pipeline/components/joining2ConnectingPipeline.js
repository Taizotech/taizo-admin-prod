...
import Joining2ConnectingFilter from "./joining2ConnectingFilter";

function Joining2ConnectingPipeline() {
  ...
  let filterDetails = useSelector(
    (state) =>
      state.CandidatePipelineDetails.joinningFollowUp2ConnectingQualifying
  );
  ...
  function paginationChange(event, page) {
    Dispatch(
      CandidatePipelineActions.setPageChange({
        type: "joinningFollowUp2ConnectingQualifying",
        value: page - 1,
      })
    );
  }
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  >
                    {el.joiningFollowup2CallReminderOn
                      ? (() => {
...
export default Joining2ConnectingPipeline;
