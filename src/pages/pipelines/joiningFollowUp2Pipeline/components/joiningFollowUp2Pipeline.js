...
import {
  ...
  Putjoinedfollowup2LeadLost,
  Updatefollowup2JoiningPipelineStatus,
...
import JoiningFollowUp2LeadFilter from "./joiningFollowUp2Filter";

function JoinningFollowUp2LeadPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joinningFollowUp2Lead
  );
  ...
  function submitCallRemainder(e) {
    ...
    setShowLoader(true);
    Updatefollowup2JoiningPipelineStatus(obj)
      .then((res) => {
        setShowLoader(false);
  ...
  function submitconfirmed() {
    ...
    Updatefollowup2JoiningPipelineStatus(obj).then(() => {
  ...
  function submitLeadLost() {
    Putjoinedfollowup2LeadLost(leadDetails.id).then(() => {
            ...
            <div className={`${style.bodyCard} p-1 `}>
              <div className={`${style.textContent} p-1 `}>
                <div className="d-flex justify-content-between">
                  ...
                  {/* <div>
                    {dateFormate(el.joiningFollowUpDate2) ===
            ...
            childComponent={
              <>
                <div style={{ width: "400px" }}>
                  {" "}
                  <div className="d-flex justify-content-between align-items-center">
                    <h5 className="text-center">Joining Update Date</h5>
...
export default JoinningFollowUp2LeadPipeline;
